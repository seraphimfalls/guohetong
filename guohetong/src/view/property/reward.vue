  ...
  <div class="body">
    ...
    <div class="upbox">
      ...
      <div class="price">
        本次充值
        <div class="price_num">
          <input type="number" v-model="inputval" placeholder="请输入充值额度">
        </div>
        元
      </div>
    ...
    <div class="paywaybox">
        ...
        <div class="imgbox">
          <div class="payimg">
            <img class = "pay_img" :src="alipay_image" alt="">
          </div>
          <!-- <div class="clickbtn" @click="bigger">点击放大</div> -->
        </div>
      </div>
      ...
      <div class="paywaybox">
        ...
        <div class="imgbox">
          <div class="payimg">
            <img class = "pay_img" :src="wechat_image" alt="">
          </div>
      ...
      <button class="en_btn" @click="recharge ()">确认充值</button>
    </div>
...
export default {
  ...
  methods: {
    ...
    async recharge(money, images){
      const res = await assetsApi.recharge(this.inputval, this.file)
      if(res.code == 0){
        this.state = 0;
                this.show = true
