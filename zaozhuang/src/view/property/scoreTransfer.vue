<template>
  <div>
    <nav-bar title="积分转PIGE币"></nav-bar>
    ...
    <div class="width96 font28 margin2 flex-box-around border-bottom2">
      <span>本次兑换</span>
      <van-field type="number" style="width:60%" v-model="num" @keyup="inputChange" placeholder="请输入兑换数量" />PIGE币
    </div>
    <div class="width96 font28 textRight coloraeaeae">
      1积分可兑换{{pigeNum}}个PIGE币价格，本次兑换消耗{{scoreNum}}个积分
    </div>
